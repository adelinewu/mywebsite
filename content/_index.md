...
运用Figma完成STC（sales task completion）样机申请、智能看板模块的原型产出。
    ...
    - company: 北京字节跳动科技有限公司
      ...
      description: |2-
          ...
          *  **产品收录标准** 摸底纸本词典与线上竞品的字词收录范围，SBS评估冲突词条并确定保留规则，与搜索侧对齐多情境下的排序方案，提升准召率，进一步优化用户体验。
          *  **合集展现与账号运营** 根据真实用户需求，多渠道梳理头部节气/节日诗词，安排生产人力完善词条并根据标签进行合集展现；运用Figma制作抖音端展示内容，从0到1开展抖音账号运营。
          *  **产品内容优化** 结合用研，撰写诗词作品评价优化规则文档，对相应人力开展操作培训。日常回查数据，对质量和效率负责。
          *  **内容生产与质量校对** 优化生产/质检SOP，回扫疑问点并针对性给出解决路径，实现审核人效提升20%。
           *  **跨部门合作** 与游戏部门合作，完成古诗词游戏的关卡与内容设计，增加产品曝光度。
